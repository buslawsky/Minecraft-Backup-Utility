...
📦 Installation & Usage
   ...
   ./backup.sh
    ...
    📂 Note: A new folder named minecraft_backups will be created inside your server directory, containing timestamped archives like backup_20260606_220000.7z.
...
📄 License & Contact
    ...
    Custom Development Services: Need a custom Minecraft plugin or advanced server scripts? I accept Crypto payments (USDT/LTC/SOL).

    💬 Contact: Connect with me on Discord or open an Issue here!
